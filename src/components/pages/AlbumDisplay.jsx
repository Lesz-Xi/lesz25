...
const AlbumDisplay = () => {
  ...
  const galleryData = {
    switzerland: [
      { type: "landscape", src: "/images/switzerland/switz-landsc-1.jpg", category: "Alpine", title: "Lucerne Lake" },
      { type: "portrait", src: "/images/switzerland/switz-port-1.jpg", category: "Street", title: "Old Town" },
      { type: "portrait", src: "/images/switzerland/switz-port-2.jpg", category: "Architecture", title: "Swiss Chalet" },
      { type: "landscape", src: "/images/switzerland/switz-landsc-2.jpg", category: "Nature", title: "Mountain Peaks" },
      { type: "portrait", src: "/images/switzerland/switz-port-3.jpg", category: "Details", title: "Window Boxes" },
      { type: "portrait", src: "/images/switzerland/switz-port-4.jpg", category: "Culture", title: "Village Life" },
      { type: "landscape", src: "/images/switzerland/switz-landsc-3.jpg", category: "Landscape", title: "Valley View" },
      { type: "portrait", src: "/images/switzerland/switz-port-5.jpg", category: "Street", title: "Cobblestone" },
      { type: "portrait", src: "/images/switzerland/switz-port-6.jpg", category: "Architecture", title: "Chapel Bridge" },
      { type: "landscape", src: "/images/switzerland/switz-landsc-4.jpg", category: "Nature", title: "Glacial Water" },
      { type: "portrait", src: "/images/switzerland/switz-port-7.jpg", category: "Details", title: "Swiss Watch" },
      { type: "portrait", src: "/images/switzerland/switz-port-8.jpg", category: "Street", title: "Zurich Streets" },
    ],
    paris: [
      { type: "landscape", src: "/images/paris/paris-landsc-1.jpg", category: "Cityscape", title: "Eiffel View" },
      { type: "portrait", src: "/images/paris/paris-port-1.jpg", category: "Street", title: "Parisian Cafe" },
      { type: "portrait", src: "/images/paris/paris-port-2.jpg", category: "Architecture", title: "Louvre Detail" },
      { type: "landscape", src: "/images/paris/paris-landsc-2.jpg", category: "Cityscape", title: "Seine River" },
      { type: "portrait", src: "/images/paris/paris-port-3.jpg", category: "Street", title: "Metro Station" },
      { type: "portrait", src: "/images/paris/paris-port-4.jpg", category: "Architecture", title: "Haussmann" },
      { type: "landscape", src: "/images/paris/paris-landsc-3.jpg", category: "Cityscape", title: "Montmartre" },
      { type: "portrait", src: "/images/paris/paris-port-5.jpg", category: "Details", title: "Bakery Window" },
      { type: "portrait", src: "/images/paris/paris-port-6.jpg", category: "Street", title: "Rainy Day" },
      { type: "landscape", src: "/images/paris/paris-landsc-4.jpg", category: "Cityscape", title: "Notre Dame" },
      { type: "portrait", src: "/images/paris/paris-port-7.jpg", category: "Architecture", title: "Opera" },
      { type: "portrait", src: "/images/paris/paris-port-8.jpg", category: "Street", title: "Street Art" },
    ],
    nature: [
      { type: "landscape", src: "/images/nature/nature-landsc-1.jpg", category: "Nature", title: "Forest Mist" },
      { type: "portrait", src: "/images/nature/nature-port-1.jpg", category: "Details", title: "Leaf Texture" },
      { type: "portrait", src: "/images/nature/nature-port-2.jpg", category: "Wildlife", title: "Morning Dew" },
      { type: "landscape", src: "/images/nature/nature-landsc-2.jpg", category: "Nature", title: "Mountain Trail" },
      { type: "portrait", src: "/images/nature/nature-port-3.jpg", category: "Details", title: "Bark Pattern" },
      { type: "portrait", src: "/images/nature/nature-port-4.jpg", category: "Wildlife", title: "Small Bird" },
      { type: "portrait", src: "/images/nature/nature-port-5.jpg", category: "Nature", title: "Tall Trees" },
      { type: "portrait", src: "/images/nature/nature-port-6.jpg", category: "Details", title: "Fern" },
      { type: "portrait", src: "/images/nature/nature-port-7.jpg", category: "Wildlife", title: "Butterfly" },
      { type: "portrait", src: "/images/nature/nature-port-8.jpg", category: "Nature", title: "Sunlight" },
      { type: "portrait", src: "/images/nature/nature-port-9.jpg", category: "Details", title: "Moss" },
      { type: "portrait", src: "/images/nature/nature-port-1.jpg", category: "Nature", title: "Green" },
    ],
    beach: [
      { type: "landscape", src: "/images/sunset/sunset-landsc-1.jpg", category: "Sunset", title: "Golden Hour" },
      { type: "portrait", src: "/images/sunset/sunset-port-1.jpg", category: "Silhouette", title: "Beach Walk" },
      { type: "portrait", src: "/images/sunset/sunset-port-2.jpg", category: "Details", title: "Waves" },
      { type: "landscape", src: "/images/sunset/sunset-landsc-2.jpg", category: "Sunrise", title: "Early Morning" },
      { type: "portrait", src: "/images/sunset/sunset-port-3.jpg", category: "Silhouette", title: "Palm Tree" },
      { type: "portrait", src: "/images/sunset/sunset-port-4.jpg", category: "Details", title: "Sand Texture" },
      { type: "landscape", src: "/images/sunset/sunset-landsc-3.jpg", category: "Sunset", title: "Horizon" },
      { type: "portrait", src: "/images/sunset/sunset-port-5.jpg", category: "Silhouette", title: "Reflections" },
      { type: "portrait", src: "/images/sunset/sunset-port-6.jpg", category: "Details", title: "Shells" },
      { type: "landscape", src: "/images/sunset/sunset-landsc-4.jpg", category: "Sunrise", title: "Dawn Colors" },
      { type: "portrait", src: "/images/sunset/sunset-port-7.jpg", category: "Silhouette", title: "Fisherman" },
      { type: "portrait", src: "/images/sunset/sunset-port-8.jpg", category: "Details", title: "Sun Rays" },
    ],
    flowers: [
      { type: "landscape", src: "/images/flowers/flowers-landsc-1.jpg", category: "Floral", title: "Garden View" },
      { type: "portrait", src: "/images/flowers/flowers-port-1.jpg", category: "Macro", title: "Rose Petal" },
      { type: "portrait", src: "/images/flowers/flowers-port-2.jpg", category: "Details", title: "Tulip" },
      { type: "landscape", src: "/images/flowers/flowers-landsc-2.jpg", category: "Floral", title: "Field of Colors" },
      { type: "portrait", src: "/images/flowers/flowers-port-3.jpg", category: "Macro", title: "Dew Drop" },
      { type: "portrait", src: "/images/flowers/flowers-port-4.jpg", category: "Details", title: "Lily" },
      { type: "landscape", src: "/images/flowers/flowers-landsc-3.jpg", category: "Floral", title: "Spring Blossom" },
      { type: "portrait", src: "/images/flowers/flowers-port-5.jpg", category: "Macro", title: "Bee on Flower" },
      { type: "portrait", src: "/images/flowers/flowers-port-6.jpg", category: "Details", title: "Sunflower" },
      { type: "landscape", src: "/images/flowers/flowers-landsc-4.jpg", category: "Floral", title: "Park Walk" },
      { type: "landscape", src: "/images/flowers/flowers-landsc-5.jpg", category: "Floral", title: "Wildflowers" },
      { type: "landscape", src: "/images/flowers/flowers-landsc-6.jpg", category: "Floral", title: "Bouquet" },
    ],
    philippines: [
      { type: "landscape", src: "/images/philippines/ph-landscape-1.jpg", category: "Island", title: "Tropical Beach" },
      { type: "portrait", src: "/images/philippines/ph-port-1.jpg", category: "Culture", title: "Festival" },
      { type: "portrait", src: "/images/philippines/ph-port-2.jpg", category: "Street", title: "Jeepney" },
      { type: "landscape", src: "/images/philippines/ph-landscape-2.jpeg", category: "Island", title: "Sunset View" },
      { type: "portrait", src: "/images/philippines/ph-port-3.jpg", category: "Culture", title: "Local Market" },
      { type: "portrait", src: "/images/philippines/ph-port-4.jpg", category: "Nature", title: "Palm Tree" },
      { type: "portrait", src: "/images/philippines/ph-port-5.jpg", category: "Street", title: "City Life" },
      { type: "portrait", src: "/images/philippines/ph-port-6.jpg", category: "Culture", title: "Tradition" },
      { type: "portrait", src: "/images/philippines/ph-port-7.jpg", category: "Nature", title: "Island Life" },
      { type: "portrait", src: "/images/philippines/ph-port-1.jpg", category: "Culture", title: "Davao" },
      { type: "portrait", src: "/images/philippines/ph-port-2.jpg", category: "Street", title: "Market" },
      { type: "portrait", src: "/images/philippines/ph-port-3.jpg", category: "Culture", title: "Community" },
    ]
  };
