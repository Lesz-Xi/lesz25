    ...
    >
      ...
      <div className="relative w-full h-full flex items-center justify-center max-w-[90vw] md:max-w-4xl mt-20">
        {projects.map((project, index) => (
          ...
          >
            {/* Image Section */}
            <div className="w-full md:w-2/3 h-[60%] md:h-full relative overflow-hidden">
               <img 
                 src={project.image} 
                 alt={project.title}
            ...
            {/* Content Section */}
            <div className="w-full md:w-1/3 h-[40%] md:h-full p-6 md:p-8 flex flex-col justify-center bg-[#1C1C21] border-l border-neutral-800">
