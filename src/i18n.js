...
const STRINGS = {
  en: {
    ...
    'res.3.kind': 'Boundary · Posture',
    'res.3.desc': 'Keeping each claim answerable — provenance, uncertainty, and boundary held visible.',

    'career.0.note': 'Causal AI workbench',
    'career.1.note': 'Companion-agent runtime',
    'career.2.note': 'Terminal-native AI workspace',
    'career.3.note': 'Observational seismic interface',
    'career.4.note': 'Academic-integrity surface',
    'career.5.note': 'Adaptive coaching system',
    'career.6.note': 'Many-worlds decision model',
    'career.7.note': 'HIV research publication (Zenodo)',
    'career.8.note': 'Affective intelligence preprint',
    'career.9.note': 'Building, seeing, asking why',
  ...
  de: {
    ...
    'res.3.kind': 'Grenze · Haltung',
    'res.3.desc': 'Jede Behauptung verantwortbar halten — Herkunft, Unsicherheit und Grenze bleiben sichtbar.',

    'career.0.note': 'Kausale KI-Werkbank',
    'career.1.note': 'Begleiter-Agenten-Laufzeit',
    'career.2.note': 'Terminal-nativer KI-Arbeitsraum',
    'career.3.note': 'Beobachtende seismische Oberfläche',
    'career.4.note': 'Oberfläche für akademische Integrität',
    'career.5.note': 'Adaptives Coaching-System',
    'career.6.note': 'Viele-Welten-Entscheidungsmodell',
    'career.7.note': 'HIV-Forschungspublikation (Zenodo)',
    'career.8.note': 'Preprint zur affektiven Intelligenz',
    'career.9.note': 'Bauen, sehen, nach dem Warum fragen',
  ...
  fr: {
    ...
    'res.3.kind': 'Limite · Posture',
    'res.3.desc': 'Garder chaque affirmation redevable — provenance, incertitude et limite tenues visibles.',
    ...
    'career.3.note': 'Interface sismique d’observation',
    'career.4.note': 'Surface d’intégrité académique',
    'career.5.note': 'Système de coaching adaptatif',
    'career.6.note': 'Modèle de décision à mondes multiples',
    'career.7.note': 'Publication de recherche VIH (Zenodo)',
    'career.8.note': 'Prépublication sur l’intelligence affective',
    'career.9.note': 'Construire, voir, demander pourquoi',
  ...
  it: {
    ...
    'res.3.kind': 'Confine · Postura',
    'res.3.desc': 'Mantenere ogni affermazione responsabile — provenienza, incertezza e confine resi visibili.',
    ...
    'career.3.note': 'Interfaccia sismica di osservazione',
    'career.4.note': 'Superficie per l’integrità accademica',
    'career.5.note': 'Sistema di coaching adattivo',
    'career.6.note': 'Modello decisionale a molti mondi',
    'career.7.note': 'Pubblicazione di ricerca sull’HIV (Zenodo)',
    'career.8.note': 'Preprint sull’intelligenza affettiva',
    'career.9.note': 'Costruire, vedere, chiedere perché',
  ...
  zh: {
    ...
    'res.3.kind': '边界 · 姿态',
    'res.3.desc': '让每一个论断都可被追问——来源、不确定性与边界始终可见。',

    'career.0.note': '因果 AI 工作台',
    'career.1.note': '伴随式智能体运行时',
    'career.2.note': '终端原生 AI 工作空间',
    'career.3.note': '观测式地震界面',
    'career.4.note': '学术诚信界面',
    'career.5.note': '自适应教练系统',
    'career.6.note': '多世界决策模型',
    'career.7.note': 'HIV 研究论文（Zenodo）',
    'career.8.note': '情感智能预印本',
    'career.9.note': '建造、观看、追问为何',
