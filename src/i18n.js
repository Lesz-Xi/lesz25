...
const STRINGS = {
  en: {
    ...
    'res.0.kind': 'Preprint · AI Alignment',
    'res.0.desc': 'Test-time latent-algebraic constraints that collapse unsafe reasoning branches before tool emission.',
  ...
  de: {
    ...
    'res.0.kind': 'Preprint · KI-Ausrichtung',
    'res.0.desc': 'Latent-algebraische Einschränkungen zur Laufzeit, die unsichere Denkzweige vor der Ausgabe von Werkzeugaufrufen zusammenbrechen lassen.',
  ...
  fr: {
    ...
    'res.0.kind': 'Prépublication · Alignement de l’IA',
    'res.0.desc': 'Des contraintes algébriques latentes au moment du test qui éliminent les branches de raisonnement dangereuses avant l’émission d’outils.',
  ...
  it: {
    ...
    'res.0.kind': 'Preprint · Allineamento dell’IA',
    'res.0.desc': 'Vincoli algebrici latenti durante il test che fanno collassare i rami di ragionamento non sicuri prima dell’emissione degli strumenti.',
  ...
  zh: {
    ...
    'res.0.kind': '预印本 · AI 对齐',
    'res.0.desc': '测试时潜在代数约束，在工具发出前压缩不安全的推理分支。',
    'res.1.kind': '预印本 · 情感智能',
