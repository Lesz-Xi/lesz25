...
const STRINGS = {
  en: {
    ...
    'career.9.note': 'School violence & containment preprint',
    'career.10.note': 'Building, seeing, asking why',
  ...
  de: {
    ...
    'career.9.note': 'Preprint zu Schulgewalt & Eindämmung',
    'career.10.note': 'Bauen, sehen, nach dem Warum fragen',
  ...
  fr: {
    ...
    'career.9.note': 'Prépublication sur la violence scolaire et la contention',
    'career.10.note': 'Construire, voir, demander pourquoi',
  ...
  it: {
    ...
    'career.9.note': 'Preprint su violenza scolastica e contenimento',
    'career.10.note': 'Costruire, vedere, chiedere perché',
  ...
  zh: {
    ...
    'career.9.note': '校园暴力与围堵预印本',
    'career.10.note': '建造、观看、追问为何',
